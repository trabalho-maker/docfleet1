...
type MembershipFeePrintActionsProps = {
  associateId: string;
  year: number;
  currentYear: number;
  autoPrint?: boolean;
...
export function MembershipFeePrintActions({
  associateId,
  year,
  currentYear,
  autoPrint = false,
}: MembershipFeePrintActionsProps) {
  ...
  return (
    <div className="no-print flex flex-wrap gap-3">
      <Link
        href={`/associados/${associateId}/mensalidades${year === currentYear ? "" : `?year=${year}`}`}
